...
import 'package:project_mobile/latihan/page_detail.dart';
  ...
  Future<void> getKampus() async {
    try {
      http.Response response = await http
          .get(Uri.parse('http://192.168.43.45/kampus/getKampus.php'));
                          ...
                          children: [
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  'http://192.168.43.45/kampus/gambar/${data?.gambar}',
                                  fit: BoxFit.cover,
                                  height: 76,
                                  width: 76,
                                ),
